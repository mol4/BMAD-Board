...
const translations = {
  ru: {
    ...
    'toast.syncComplete': 'Синхронизация завершена',
    'toast.syncFailed': 'Ошибка синхронизации. Проверьте пути.',
    ...
    'toast.fileLockedByAgent': 'Файл редактируется AI-агентом. Пожалуйста, подождите.',
    ...
    'dashboard.activeSubtitle': 'В работе + На ревью',
    ...
    'story.changeStatus': 'Сменить статус',
    'story.tab.info': 'Информация',
    'story.tab.markdown': 'Markdown',
  ...
  en: {
    ...
    'dashboard.activeSubtitle': 'In Progress + In Review',
    ...
    'story.changeStatus': 'Change status',
    'story.tab.info': 'Info',
    'story.tab.markdown': 'Markdown',
    ...
    'toast.syncFailed': 'Sync failed. Check file paths.',
    ...
    'toast.fileLockedByAgent': 'File is being edited by AI agent. Please wait.',
